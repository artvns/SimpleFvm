...
const std::string NAME_PART = "22x19_horizFaces";
...
void executeCalculation3() {
    ...
    partTypeChooserModule_.set_MOVING_WALL("f", 0.0025);
    partTypeChooserModule_.set_MOVING_WALL("g", 0.001);
    partTypeChooserModule_.set_STATIC_WALL("h");
    partTypeChooserModule_.set_STATIC_WALL("i");
    partTypeChooserModule_.set_STATIC_WALL("j");
...
TEST(MeshQuadHorizFaces22x19Test, test_1) {
    executeCalculation3();
