...
SolverFluidPropsMask& InitialDataDefaultIter2::getFluidPropsMask() {
...
SolverAdjCellInteriorNumsPMask& InitialDataDefaultIter2::
                                            getAdjCellInteriorNumsPMask() {

    return adjCellInteriorNumsPMask_;
}

ScalarsStore& InitialDataDefaultIter2::getScalarsStore() {
...
void InitialDataDefaultIter2::createAdjCellNumsInterior() {
    size_t cells_ = 6; 
