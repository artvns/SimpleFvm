...
double ExpectedResultDefaultIter2::getDw(size_t step) {
    return Dw_.at(step);
}

double ExpectedResultDefaultIter2::getDe(size_t step) {
    return De_.at(step);
}

double ExpectedResultDefaultIter2::getDn(size_t step) {
    return Dn_.at(step);
}

double ExpectedResultDefaultIter2::getDs(size_t step) {
    return Ds_.at(step);
}
